...
public class DESEncryptPanel extends JPanel
{
	...
	public DESEncryptPanel()
	{
		...
		fileBrowseButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event)
			{
				...
				int result = fileChooser.showOpenDialog(DESEncryptPanel.this);
		...
		encryptButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event)
			{
				...
				if (password.isEmpty() || password.length() != 8)
				{
					...
					JOptionPane.showMessageDialog(DESEncryptPanel.this, message, "Notice", JOptionPane.INFORMATION_MESSAGE);
				}
				else
				{
					...
					fileChooser.resetChoosableFileFilters();
					fileChooser.setAcceptAllFileFilterUsed(true);
					int result = fileChooser.showSaveDialog(DESEncryptPanel.this);
					if (result == JFileChooser.APPROVE_OPTION)
					{
						...
						try
						{
							...
							DES.getInstance().encrypt(filePath, savePath, password);
							long estimatedTime = System.nanoTime() - startTime;
							System.out.println("DES Encryption Time: " + estimatedTime);
						}
